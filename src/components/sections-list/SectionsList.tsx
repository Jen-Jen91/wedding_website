  ...
  return (
    <main className="main">
      ...
      <Section sectionId="story" linkId="Story" header="Our Story">
        ...
        <p>
          Covid hit and although it caused chaos in all our lives, it brought us
          closer together and Jen proposed to Tomek in June 2020.
        </p>
        <p>
          We bought our own place in 2021 and finally booked our wedding venue.
        </p>
        <p>
      ...
      >
        <p>Country house and estate in Fife, a short drive from St Andrews.</p>
        <p>
      ...
      <Section sectionId="photos" linkId="Photos" header="Photos">
        <p>
          After the wedding, we'll upload professional and guest photos here for
          you all to view.
        </p>
      </Section>
